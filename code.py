...
class Atom:
    def __init__(
        ...
        # It distinguishes residues such as 100, 100A, 100B.
        # So residue_id alone is not always enough to uniquely identify a residue.
    ...
    def residue_key(self):
        # Use chain_id + residue_id + insertion_code + residue_name together
        # to avoid merging different residues like 100 and 100A.
        return (
            self.chain_id,
            self.residue_id,
            self.insertion_code,
    ...
    with open(filepath, "r") as f:
        for line in f:
            ...
            try:
                ...
                # Column 27 in PDB format is the insertion code.
                # It is usually empty, but may contain A/B/... for inserted residues.
...
def aggregate_residue_sasa(atoms):
    ...
    for atom in atoms:
        # Aggregate by residue_key instead of residue_id alone,
        # because two residues may share the same residue_id but differ
        # in insertion_code, e.g. 100 and 100A.
